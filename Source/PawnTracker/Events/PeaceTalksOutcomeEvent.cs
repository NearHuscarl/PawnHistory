...
internal static class CaravanIncidentUtility_SetupCaravanAttackMap_Patch
{
    ...
    {
        if (__result == null || caravan == null || enemies == null || enemies.Count == 0)
            return;
        ...
        GameEventBus.Publish(new PeaceTalksOutcomeEvent(negotiator, enemies[0].Faction, PeaceTalksOutcome.Disaster, enemies));
